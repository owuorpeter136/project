    ...
    <div class="form2">
        ...
        <div class="side-menu">
          ...
          <ul>
            ...
            <li><a href="index.php" style="text-decoration: none;"><img src="avatar.PNG" style="width: 30px; height: 30px; margin: 2px;"><span>Apply For Inputs</span></li>
...
<center><p style="margin-top:10px; text-align: center; margin-top: 5%;">Welcome Farmer Portal</p><center>
